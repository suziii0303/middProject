	...
	<div id="bodydiv">
		...
		<div class="container">
			<div class="row input-container">
				<form name="uform" id="uform" action="<%=request.getContextPath() %>/NoticeUpdate.do" enctype="multipart/form-data" method="post">
					<div class="col-xs-12">
						<div class="styled-input wide">
							<input type="text" class="txt" id="title" name="no_subject" value="<%=vo.getNo_subject() %>" required />
							<label>💡 공지 타이틀을 입력해주세요!</label> 
						</div>
					</div>
					<div class="col-xs-12">
						<div class="styled-input wide">
							<textarea class="txt" id="content" name="no_content" required><%=vo.getNo_content() %></textarea>
					...
					<div class="filebox">
						...
						<input type="hidden" name="no_writer" value="<%=vo.getNo_writer()==null ? "" : vo.getNo_writer()%>">
						<input type="hidden" name="no_num" value="<%=vo.getNo_num() %>">
					</div>
					<div id="buttons">
