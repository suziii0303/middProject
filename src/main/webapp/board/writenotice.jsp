	...
	<div id="bodydiv">
		...
		<div class="container">
			<div class="row input-container">
				<form name="wform" id="wform" action="<%=request.getContextPath() %>/NoticeWrite.do" enctype="multipart/form-data" method="post">
					<div class="col-xs-12">
						<div class="styled-input wide">
							<input type="text" class="txt" id="title" name="no_subject" required />
							<label>💡 공지 타이틀을 입력해주세요!</label> 
						</div>
					</div>
					<div class="col-xs-12">
						<div class="styled-input wide">
							<textarea class="txt" id="content" name="no_content" required></textarea>
