...
$(function() {
	...
	qnaListPageServer(currentPage);
	
	// 검색
	$('#searchQna').on('keypress', function(key) {
		if(key.keyCode == '13') {
			qnaListPageServer(1);
		}
	})
	...
	$(document).on('click', '#writebtn', function() {
		location.href = "<%=request.getContextPath()%>/QnaWrite.do";
	})	
})
...
%>
	...
	<div id='wrapper'>
		...
		<div id="subnav">
			<h2 class="noticeh2">Q&A 게시판</h2>
			<form class="search" onsubmit="return false">
				<div class="searchbar">
					<img id="searchicon" src="<%=request.getContextPath()%>/images/search.png">
					<input id="searchQna" type="text" placeholder="검색어를 입력해 주세요." name="search">
				</div>
			</form>
		</div> <!-- Q&A h2, 서치바 -->
