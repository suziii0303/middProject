...
<%
 ClientVO clientVo = (ClientVO)request.getAttribute("clientVo");
%>

<form action="<%=request.getContextPath()%>/updateClient.do" method="post" >
<div class="title">🙆🏻고객 정보 수정🙆🏻</div>
<input type="hidden" name="c_id" value="<%=clientVo.getC_id()%>">


      <div class="input-container ic1">
      <input id="id" class="input" type="text" value="<%=clientVo.getC_id()%>" readonly >
<div class="cut"></div>    
      <label for="id" class="placeholder">고객ID</label>
</div>

        <div class="input-container ic2">
        <input id="name" name="c_nm" class="input" type="text" value="<%=clientVo.getC_nm()%>"> 
        <div class="cut"></div>
      ...
      <div class="input-container ic3">
        <input id="pass" name="c_pass" class="input" type="text" value="<%=clientVo.getC_pass()%>"> 
        <div class="cut"></div>
       ...
       <div class="input-container ic3">
        <input id="tel" name="c_tel"  class="input" type="text" value="<%=clientVo.getC_tel()%>" >
        <div class="cut"></div>
        <label for="tel" class="placeholder">전화번호</label>
      </div>

       <div class="input-container ic4">
        <input id="email" name="c_email"  class="input" type="text" value="<%=clientVo.getC_email()%>" >
        <div class="cut"></div>
        <label for="email" class="placeholder">이메일</label>
      </div>
      
             <div class="input-container ic5">
        <input id="bir" name="c_bir"  class="input" type="text" value="<%=clientVo.getC_bir()%>" >
        <div class="cut"></div>
        <label for="bir" class="placeholder">생년월일</label>
      </div>
      
        <div class="input-container ic6">
        <input id="add" name="c_add"  class="input" type="text" value="<%=clientVo.getC_add()%>" >
        <div class="cut"></div>
        <label for="add" class="placeholder">주소</label>
      </div>
      

<div class="input-container ic7">
  <div class="cut"><p>성별</div>

  <input id="gend" name="c_gend" class="radio" type="radio" value="남" <% if (clientVo.getC_gend().equals("남")) { %>checked<% } %>>
  <label for="male" class="gender">남</label>
  <input id="gend" name="c_gend" class="radio" type="radio" value="여" <% if (clientVo.getC_gend().equals("여")) { %>checked<% } %>>
