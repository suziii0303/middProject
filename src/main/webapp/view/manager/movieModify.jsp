...
%>
<section id="movie">     
<form action="<%=request.getContextPath()%>/updateMovie.do" method="post" >
<div class="title">🎬‍영화 정보 수정🎬</div>

<input type="hidden" name="m_id" value="<%=movieVo.getM_id()%>">

<div id = "bigdiv" >

<div id= "leftdiv">
      <div class="input-container ic1">
      <input id="id" class="input" type="text" value="<%=movieVo.getM_id()%>" readonly >
<div class="cut"></div>    
      <label for="id" class="placeholder">영화ID</label>
</div>

      <div class="input-container ic2">
        <input id="mrid" name="mr_id" class="input" type="text" value="<%=movieVo.getMr_id()%>">
        <div class="cut"></div>
        <label for="mrid" class="placeholder">연령등급</label>
      </div>

        <div class="input-container ic3">
        <input id="subject" name="m_subject" class="input" type="text" value="<%=movieVo.getM_subject()%>"> 
        <div class="cut"></div>
        <label for="subject" class="placeholder">영화제목</label>
      </div>
      
            <div id = "filebox" class="input-container ic4">
        <input id="ex_file" name="m_post" class="input" type="file" value="<%=movieVo.getM_post()%>" >
        <div class="cut"></div>
        <label for="ex_file" class="placeholder">영화포스터</label>
      </div>
     
       <div class="input-container ic5">
         <textarea id="plot" name="m_plot" class="input"><%=movieVo.getM_plot().replaceAll("<br>", "\\\n") %></textarea>
        <div class="cut"></div>
   ...
   <div id= "rightdiv">   
       <div class="input-container ic5">
        <input id="director" name="m_director"  class="input" type="text" value="<%=movieVo.getM_director()%>">
        <div class="cut"></div>
        <label for="director" class="placeholder">감독</label>
      </div>
      
             <div class="input-container ic5">
        <input id="date" name="m_date"  class="input" type="text" value="<%=movieVo.getM_date()%>" >
        <div class="cut"></div>
        <label for="date" class="placeholder">개봉날짜</label>
      </div>
      
             <div class="input-container ic5">
        <input id="genre" name="m_genre"  class="input" type="text" value="<%=movieVo.getM_genre()%>">
        <div class="cut"></div>
       ...
       <div class="input-container ic5">
        <input id="runtime" name="m_runtime"  class="input" type="text" value="<%=movieVo.getM_runtime()%>">
        <div class="cut"></div>
        <label for="runtime" class="placeholder">상영시간</label>
      </div>
          
             <div class="input-container ic5">
        <textarea id="actor" name="m_actor"  class="input"><%=movieVo.getM_actor()%></textarea>
        <div class="cut"></div>
